...
export default class Reading extends Component {
    render() {
        return (
            <div>
                <Typography fontWeight="fontWeightBold" variant="h3" style={{ paddingTop: "45px", textAlign: 'center', paddingBottom: "20px", fontFamily: "Comfortaa", fontSize: "36px"}} >
                    {"Read this aloud!"}
                </Typography>
                <Typography variant="h3" style={{ paddingTop: "20px", textAlign: 'center', paddingBottom: "20px", fontFamily: "Source Sans Pro", fontSize: "20px"}} >
